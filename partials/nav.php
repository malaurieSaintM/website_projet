...
<nav class="col-3 py-2 categories-nav">
	...
	<a class="d-block btn btn-primary mb-4 mt-2" href="../views/login-register.php">Connexion / inscription</a>
	<?php endif; ?>

	<b>Catégories :</b>
	<ul>
		<li><a href="../views/article_list.php">Tous les articles</a></li>
		<!-- liste des catégories -->
		<?php while($category = $query->fetch()): ?>
		<li><a href="../views/article_list.php?category_id=<?= $category['id']; ?>"><?= $category['name']; ?></a></li>
		<?php endwhile; ?>

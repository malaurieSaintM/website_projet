				...
				<section class="col-9">
					...
					<form action="user-form.php" method="post">
						<div class="form-group">
							...
							<input class="form-control" <?php if(isset($user)): ?>value="<?= $user['firstname']?>"<?php endif; ?> type="text" placeholder="Prénom" name="firstname" id="firstname" />
						</div>
						<div class="form-group">
							<label for="lastname">Nom de famille : </label>
							<input class="form-control" <?php if(isset($user)): ?>value="<?= $user['lastname']?>"<?php endif; ?> type="text" placeholder="Nom de famille" name="lastname" id="lastname" />
						</div>
						<div class="form-group">
							<label for="email">Email :</label>
							<input class="form-control" <?php if(isset($user)): ?>value="<?= $user['email']?>"<?php endif; ?> type="email" placeholder="Email" name="email" id="email" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="bio" id="bio" placeholder="Sa vie son oeuvre..."><?php if(isset($user)): ?><?= $user['bio']?><?php endif; ?></textarea>
						</div>
						<div class="form-group">
